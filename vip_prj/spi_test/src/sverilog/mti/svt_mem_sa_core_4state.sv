...
`include `SVT_SOURCE_MAP_LIB_INCLUDE_SVI(V-2023.12,svt_mem_sa_dpi)
...
//======================================================================
  ...
  function int create_pattern(
    ...
    input  logic [`SVT_MEM_MAX_DATA_WIDTH-1:0]  optional_data, // pattern optional data 
    output int                 pat_id,                         // pattern identifier
    input  longint unsigned    sim_time  );                    // simulation time

    return svt_mem_sa_inst_create_pattern( inst_handle, pat_spec, base_data, optional_data, pat_id, sim_time);
...
Bm81m2rp0U3w5HwW8YjOcgZUromxiGtOSnjWKOGHmzIQo9UAva8IpmzmzIo1ETT3
KQrKTu0T15DAnJjeYgtAODVYvtWmpxle/WfEDZ4gVF+/vve5DPdmOnUWeSL15eIQ
EhVKk7z2vZkEhZc5ArXBDXlxvRMPBtkcRm9/Pdgzw1I=
`pragma protect data_block encoding = ( enctype = "base64", bytes = 83        )
Ep3lf8w22J2VMBxWBcwdos8oivq1R7UsDBlyYpHKXtA4OhN2sz+s7ty9vqerewcM
HQT0mPfeKO/aSzxK8D+AYPBgE0FUjsrSkhT9PLVcaEptC5vT7cS18TT3LyCoWUop
